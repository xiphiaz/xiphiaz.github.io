...
angular.module('app.public.error', [])
    ...
    .config(["stateHelperServiceProvider", "$httpProvider", function(stateHelperServiceProvider, $httpProvider) {
    ...
    .controller('app.public.error.controller', ["$rootScope", "$scope", "$stateParams", "$state", "$window", "$filter", function($rootScope, $scope, $stateParams, $state, $window, $filter) {
