angular.module('stateManager', [
    ...
    .config(["$stateProvider", "$locationProvider", "$urlRouterProvider", "$compileProvider", "stateHelperServiceProvider", function($stateProvider, $locationProvider, $urlRouterProvider, $compileProvider, stateHelperServiceProvider) {
    ...
    .controller('stateManager.navigation.controller', ["$scope", "stateHelperService", "$window", function($scope, stateHelperService, $window) {
