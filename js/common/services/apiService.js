angular.module('apiService', [])
    .factory('apiService', ["$rootScope", "$http", "$q", "$window", "$stateParams", "$location", "API_URL", "siteProgressService", function ($rootScope, $http, $q, $window, $stateParams, $location, API_URL, siteProgressService) {
